...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0')
      s.add_runtime_dependency('coffee-script'.freeze, ['>= 2.2.0'])
      s.add_runtime_dependency('railties'.freeze, ['>= 4.0.0'])
    else
      s.add_dependency('coffee-script'.freeze, ['>= 2.2.0'])
      s.add_dependency('railties'.freeze, ['>= 4.0.0'])
    end
  else
    s.add_dependency('coffee-script'.freeze, ['>= 2.2.0'])
    s.add_dependency('railties'.freeze, ['>= 4.0.0'])
