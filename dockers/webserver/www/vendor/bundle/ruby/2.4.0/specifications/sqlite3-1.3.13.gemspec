...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0')
      s.add_development_dependency('minitest'.freeze, ['~> 5.9'])
      s.add_development_dependency('rdoc'.freeze, ['~> 4.0'])
      s.add_development_dependency('rake-compiler'.freeze, ['~> 0.9.3'])
      s.add_development_dependency('rake-compiler-dock'.freeze, ['~> 0.5.2'])
      s.add_development_dependency('mini_portile'.freeze, ['~> 0.6.2'])
      s.add_development_dependency('hoe-bundler'.freeze, ['~> 1.0'])
      s.add_development_dependency('hoe'.freeze, ['~> 3.15'])
    else
      s.add_dependency('minitest'.freeze, ['~> 5.9'])
      s.add_dependency('rdoc'.freeze, ['~> 4.0'])
      s.add_dependency('rake-compiler'.freeze, ['~> 0.9.3'])
      s.add_dependency('rake-compiler-dock'.freeze, ['~> 0.5.2'])
      s.add_dependency('mini_portile'.freeze, ['~> 0.6.2'])
      s.add_dependency('hoe-bundler'.freeze, ['~> 1.0'])
      s.add_dependency('hoe'.freeze, ['~> 3.15'])
    end
  else
    s.add_dependency('minitest'.freeze, ['~> 5.9'])
    s.add_dependency('rdoc'.freeze, ['~> 4.0'])
