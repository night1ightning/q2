...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0')
      ...
      s.add_development_dependency('minitest-sprint'.freeze, ['>= 0'])
      s.add_development_dependency('concurrent-ruby'.freeze, ['>= 0'])
      s.add_development_dependency('rake'.freeze, ['>= 0'])
    else
      s.add_dependency('minitest'.freeze, ['~> 5.0'])
      s.add_dependency('minitest-sprint'.freeze, ['>= 0'])
      s.add_dependency('concurrent-ruby'.freeze, ['>= 0'])
